...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    ...
    $employeeRoutes = function ($employeeIndexMethod = 'index') {
        ...
        Route::put('/employees/{employee}/dtr', [EmployeeController::class, 'updateDTRIndividualy'])->name('employees.dtr.updateDtr');
    ...
    $salesReportRoutes = function () {
        ...
        Route::get('/reports/export-sales-summary-report', [ReportController::class, 'exportSalesSummaryReport'])->name('sales.export-sales-summary-report');
    };
