...
class InventoryController extends Controller
{
    ...
    public function items(Request $request)
    {
        ...
        // $items = InventoryItem::with(['category', 'movements'])
    ...
    public function store(Request $request)
    {
        ...
        // $created_item = InventoryItem::create($request->all());
        $created_item = InventoryItem::create([
            ...
            'created_by' => auth()->id(), // ✅ added
            'updated_by' => NULL, // ✅ added
            'orderable' => $request->orderable, // ✅ added
        ]);
