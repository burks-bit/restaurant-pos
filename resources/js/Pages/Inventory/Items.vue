  ...
  <AuthenticatedLayout>
    <div class="container mx-auto py-6">
      <div class="p-4 bg-gray-50">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-2 py-1 border flex gap-2">
                  ...
                  <button
                    class="flex items-center gap-1 px-2 py-1 text-sm bg-yellow-500 text-white rounded hover:bg-yellow-600"
                    @click="openPhysicalCount(item)"
                  >
                    <i class="fa fa-clipboard"></i> Count
                  </button>
                </td>
              </tr>
        ...
        <div
          v-if="showPhysicalCountModal"
          class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
        >
          <div class="bg-white rounded-lg w-full max-w-md p-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-1">
              Physical Count - {{ selected.name }}
            </h2>
            <p class="text-sm text-gray-500 mb-4">
              Enter the actual counted quantity from the storage/market today.
            </p>

            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium mb-1">Actual Count (packs/unit)</label>
                <input
                  type="number"
                  v-model="physicalCountForm.quantity"
                  min="0"
                  required
                  class="w-full border-gray-300 rounded px-3 py-2 text-sm"
                  placeholder="e.g. 10"
              ...
              <div>
                ...
                <input
                  type="text"
                  v-model="physicalCountForm.note"
                  class="w-full border-gray-300 rounded px-3 py-2 text-sm"
                  placeholder="e.g. counted by Juan"
                />
              </div>
