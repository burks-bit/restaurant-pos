...
<template>
  ...
  <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
    ...
    <Dropdown align="left" width="48">
      ...
      <template #content>
        ...
        <DropdownLink :href="route('purchaser.inventory.items')">
          Inventory Items
        </DropdownLink>

        <DropdownLink :href="route('purchaser.inventory')">
          Inventory Summary
        </DropdownLink>
      </template>
    </Dropdown>
  ...
  <div class="sm:hidden space-y-1 mt-2">
    ...
    <!-- <ResponsiveNavLink :href="route('purchaser.inventory')">POS</ResponsiveNavLink> -->
